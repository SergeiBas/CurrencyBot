...
import bot.telegrambot.buttonmenus.BankMenu;
import bot.telegrambot.buttonmenus.CurrencyMenu;
import bot.telegrambot.buttonmenus.DecimalMenu;
import bot.telegrambot.buttonmenus.RemindersMenu;
import bot.userssetting.ChatBotSettings;
import bot.userssetting.SettingUtils;
        ...
        if (update.hasMessage()) {
            ...
            if (message.hasText()) {
                ...
                switch (text) {
                    ...
                    case "Отримати курси валют", "/info" -> {
